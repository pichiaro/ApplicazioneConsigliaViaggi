...
public class FiltraggioRistorantiHandler extends AbstractPositionablesHandler {

    private FullscreenChoicesDialog cucinaDialog;
    ...
    public FiltraggioRistorantiHandler(Activity activity, PositionUtility positionUtility, InterfacciaQuery interfacciaQuery, CVComponentiFactory componentiFactory, PositionableTransformer positionableTransformer) {
        ...
        this.positionDialog = componentiFactory.buildFullscreenInsertDialog(CVComponentiFactory.POSIZIONE_RISTORANTI);
        this.cucinaDialog = componentiFactory.buildFullscreenChoicesDialog(CVComponentiFactory.TIPOLOGIE_CUCINA_RISTORANTI);
        this.choicesDialog = componentiFactory.buildFullscreenChoicesDialog(CVComponentiFactory.SERVIZI_RISTORANTI);
        this.dataOraDialog = componentiFactory.buildFullscreenCalendarDialog(CVComponentiFactory.DATAORA_RISTORANTI);
        this.priceMultiSlider = componentiFactory.buildDoubleThumbMultiSlider(CVComponentiFactory.COSTO_RISTORANTI);
        ...
        this.sortSpinner = componentiFactory.buildSpinner(CVComponentiFactory.ORDINA_RISTORANTI, this.reverseSortCompoundButton);
    ...
    public FullscreenChoicesDialog getCucinaDialog() {
        return this.cucinaDialog;
    }
    ...
    protected String buildRequest() {
        ...
        String tipologieCucina[] = this.cucinaDialog.getSelectedsAsArray();
        ...
        String selectRistoranti = interfacciaQuery.getSelectRistoranti(data, ora, numeroAdulti, numeroBambini, minCosto, maxCosto, minVotoRecensioniMedio, maxVotoRecensioniMedio, servizi, tipologieCucina, position, maxDistanza, attributo, this.reverseSortCompoundButton.isChecked(), numMax);
