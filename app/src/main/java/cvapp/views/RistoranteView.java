...
public class RistoranteView extends AbstractStrutturaView {

    public RistoranteView(Activity activity, AbstractRistoranteModel ristoranteModel) {
        super(activity, ristoranteModel);
        ...
        String nome = ristoranteModel.getName();
        this.setName(nome);
        ...
        Drawable drawable = resources.getDrawable(R.drawable.restaurant, null);
        ...
        String indirizzo = ristoranteModel.getAddress();
        String citta = ristoranteModel.getCity();
        String paese = ristoranteModel.getCountry();
        ...
        String costo = String.valueOf(ristoranteModel.getCosto());
        costo = "   " + costo + " (medio)";
        textView = new TextView(activity);
        ...
        String giornoChiusura = ristoranteModel.getGiornoChiusura();
        ...
        String orarioApertura = ristoranteModel.getOraApertura();
        String orarioChiusura = ristoranteModel.getOraChiusura();
        textView = new TextView(activity);
        ...
        AbstractList<String> servizi = ristoranteModel.getServiziAndCucina();
        String concaten = "";
        ...
        String votoRecensioni = String.valueOf(ristoranteModel.getRating());
