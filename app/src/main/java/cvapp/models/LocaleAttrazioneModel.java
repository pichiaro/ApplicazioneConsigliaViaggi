...
public class LocaleAttrazioneModel extends AbstractAttrazioneModel {
    ...
    public float getCosto() {
        if (this.getValue(0) instanceof Serializable[]) {
            Float.parseFloat(String.valueOf(this.getValue(7)));
        }
    ...
    @Override
    public AbstractList<String> getServiziAndGuida() {
        String string = "";
        if (this.getValue(0) instanceof Serializable[]) {
    ...
    public float getLatitude() {
        if (this.getValue(0) instanceof Serializable[]) {
            Float.parseFloat(String.valueOf(this.getValue(13)));
        }
    ...
    public float getLongitude() {
        if (this.getValue(0) instanceof Serializable[]) {
            Float.parseFloat(String.valueOf(this.getValue(14)));
        }
