...
public class LocaleRistoranteModel extends AbstractRistoranteModel {
    ...
    public float getCosto() {
        if (this.getValue(0) instanceof Serializable[]) {
            return Float.parseFloat(String.valueOf(this.getValue(6)));
        }
    ...
    @Override
    public AbstractList<String> getServiziAndCucina() {
        String string = "";
        if (this.getValue(0) instanceof Serializable[]) {
            string = (String) this.getValue(10);
        }
        else {
    ...
    public float getRating() {
        if (this.getValue(0) instanceof Serializable[]) {
            return Float.parseFloat(String.valueOf(this.getValue(11)));
        }
